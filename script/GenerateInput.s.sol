...
// Took it from related course resource in Github which is Advanced Foundry Lesson 5

// +++ It is a script that now going to on-chain so don't need to worry about gas, DoS or anything like that...
...
contract GenerateInput is Script {
    uint256 private constant AMOUNT = 25 * 1e18; // amount of addresses will be claiming
    string[] types = new string[](2); // types of the values in the trees (which in our case is only address and amount)
    uint256 count; // numbers of addresses who will be able to claim
    string[] whitelist = new string[](4); // claim allowed address array
    string private constant INPUT_PATH = "/script/target/input.json"; // where to print this
